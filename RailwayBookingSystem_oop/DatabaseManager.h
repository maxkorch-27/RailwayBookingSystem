...
{
public:
	static vector<Train> loadTrains(const string& trainsFile, const string& stationsFile, const string& coachesFile);
    ...
    static void saveTickets(const string& filename, const vector<unique_ptr<Ticket>>& tickets);
};